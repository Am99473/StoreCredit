...
for path in os.listdir(dir_path):
    ...
    if os.path.isfile(os.path.join(dir_path, path)):
        ...
        print('assets/input/{}'.format(path))

        data = pd.read_csv('assets/input/{}'.format(path))
        ...
        datadata.to_csv('assets/output/result______________{}.csv'.format(file_no))
...
for path in os.listdir(dir_path):
    ...
    if os.path.isfile(os.path.join(dir_path, path)):
        ...
        data = pd.read_csv('assets/output/{}'.format(path))
